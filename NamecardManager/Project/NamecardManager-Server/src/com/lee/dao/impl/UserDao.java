...
public class UserDao implements IUserDao {
	...
	public User findByExample(String property, Object value) {
		String sql = "select id,name,icon_id as iconId,password,security_answer as securityAnswer,security_id as securityId from nm_user where " + property + "=?";
		return dbutilsTemplate.query(sql, new BeanHandler<User>(User.class), value);
	}

	@Override
	public int add(User user) {
		String sql = "insert into nm_user(name,icon_id,password,security_answer,security_id) values(?,?,?,?,?)";
	...
	public int updateExampleById(int id, String property, Object value) {
		String sql = "update nm_user set " + property + "=? where id=?";
