...
public class MainActivity extends Activity implements OnClickListener{
	...
	private Button mButton_record;			//名片录入
	private Button mButton_query;			//查看名片
	...
	protected void onDestroy() {
		super.onDestroy();
		//程序退出，更改状态
//		NMApplication.getInstance().setLogin(false);
	}
...
//				startActivity(mIntent);
			...
			case R.id.main_btn_record:
				//名片录入
				mIntent = new Intent(this, NamecardRecordActivity.class);
				startActivity(mIntent);
				break;

			case R.id.main_btn_query:
				//查看名片
				mIntent = new Intent(this, NamecardQueryActivity.class);
				startActivity(mIntent);
				break;
